defmodule LiveCharts.Adapter do
  ...
  into a JS charting library specific configuration.

  It will usually expose a LiveView hook to handle dynamic data
  updates as well.

  LiveCharts ships with the default `LiveCharts.Adapter.ApexCharts`
  adapter.

  ## Example

  To define a new adapter for your favorite JS charting library,
  or override Hook or options, you must call `use LiveCharts.Adapter`
